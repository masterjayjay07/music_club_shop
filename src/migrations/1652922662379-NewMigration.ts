...
export class NewMigration1652922662379 implements MigrationInterface {
    name = 'NewMigration1652922662379'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "products" RENAME COLUMN "created_at" TO "create_at"`);
        await queryRunner.query(`CREATE TABLE "order" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "userId" character varying NOT NULL, "status" character varying NOT NULL, CONSTRAINT "PK_1031171c13130102495201e3e20" PRIMARY KEY ("id"))`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "products" ALTER COLUMN "create_at" DROP DEFAULT`);
        ...
        await queryRunner.query(`ALTER TABLE "products" RENAME COLUMN "create_at" TO "created_at"`);
    }
